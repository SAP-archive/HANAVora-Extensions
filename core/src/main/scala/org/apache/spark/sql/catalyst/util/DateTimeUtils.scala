...
/**
  ...
  * precision.
  */
private[catalyst] object DateTimeUtils {
  ...
  /* XXX: Added to ease Spark 1.4 compatibility */
  def timestampToMicros(input: Any): Long = {
    val timestamp = input.asInstanceOf[Timestamp]
