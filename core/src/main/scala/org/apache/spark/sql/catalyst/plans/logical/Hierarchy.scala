...
/**
  ...
  */
case class Hierarchy(spec: HierarchySpec, node: Attribute) extends UnaryNode {
  ...
  lazy val identifier: String = spec.identifier
  ...
  override def missingInput: AttributeSet =
    references -- inputSet -- spec.prunedAttributes - node
}
